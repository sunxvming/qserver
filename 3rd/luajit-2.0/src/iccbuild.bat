...
@setlocal
@rem fancy
@set LJCOMPILE=icl /nologo /c /MT /O2 /W3 /D_CRT_SECURE_NO_DEPRECATE /DLUAJIT_DISABLE_FFI
@set LJCOMPILED=icl /nologo /c /MTd /Zi /Fd"lua51d.pdb" /W3 /D_CRT_SECURE_NO_DEPRECATE /DLUAJIT_DISABLE_FFI /DLUA_USE_ASSERT /DLUA_USE_APICHECK
