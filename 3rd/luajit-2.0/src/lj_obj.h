...
//fancy
#define sizeudata(u)	(sizeof(struct GCudata)+(u)->size)
...
// fancy
int (*weaking)(lua_State *l, const void *t, long long k, long long v, uint8_t closing); // GCtab*,TValue,TValue
GCRef mread; // nil or table
// colo, GCtab*
uint16_t intn;
uint16_t refn;
GCRef *end;
