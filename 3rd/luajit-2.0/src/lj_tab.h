...
LJ_FUNCA GCtab *lj_tab_newb(lua_State *L, uint32_t asize, uint32_t hbits, uint16_t intn, uint16_t refn); // fancy
...
LJ_FUNC void LJ_FASTCALL lj_tab_clear(lua_State *g, GCtab *t);
