...
// fancy
extern void (*lua_logalloc)(int size, const char *name, const char* source, int line);
extern void (*lua_logtable) ( const char* name, const char* source, int line );
