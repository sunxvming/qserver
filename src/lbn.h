/*
* lbn.c
* big-number library for Lua 5.2 based on OpenSSL bn
* Luiz Henrique de Figueiredo <lhf@tecgraf.puc-rio.br>
* 09 May 2012 22:20:15
...
static void lbn_error(lua_State *L, const char *message)
{
...
{
 BIGNUM *x=BN_new();
 if (x==NULL) lbn_error(L,"BN_new failed");
 lua_boxpointer(L,x);
...
static BIGNUM *Bget(lua_State *L, int i)
{
 switch (lua_type(L,i))
 {
  ...
  default:
   return (BIGNUM*) *((void**)luaL_checkudata(L,i,MYTYPE));
 }
 return NULL;
}
