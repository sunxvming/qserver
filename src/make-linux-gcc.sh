...
g++ -std=c++0x \
  ...
  -DSERVER *.cpp *.c \
  ../Library/libnavpath.a ../Library/libluajit.a ../Library/zlib.a ../Library/libxls-linux.a ../Library/libcrypto.a ../Library/libmysqlclient-linux.a \
  -static-libgcc -m32 -msse -pthread -o qserver-gcc \
